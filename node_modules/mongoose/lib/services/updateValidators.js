            ...
            if (keys[i] === '$push' || keys[i] === '$addToSet') {
                ...
                for (var ii = 0; ii < _keys.length; ++ii) {
                    if (castedDoc[keys[i]][_keys[ii]].$each) {
                        arrayAtomicUpdates[_keys[ii]] = (arrayAtomicUpdates[_keys[ii]] || []).concat(castedDoc[keys[i]][_keys[ii]].$each);
                    } else {
                        arrayAtomicUpdates[_keys[ii]] = (arrayAtomicUpdates[_keys[ii]] || []).concat([castedDoc[keys[i]][_keys[ii]]]);
                    }
                }
                continue;
            }
